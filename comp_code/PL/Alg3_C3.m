function [performance_compare, x_agent, x_bar, transmit] = Alg3_C3(x0, n_agents, gc1, gc2, gc3, gc4, gc5, G_gf, L_aug, T)
    
    fprintf('Starting Alg3_C3 ... \n');
    iter_num = T;
    ...
    for t = 2:T
        ...
        x_hat_temp = x_hat(:, t);
        for i = 1:n_agents
            q_0(i) = Norm_sign(x_iter(i) - x_hat_temp(i));
        end
