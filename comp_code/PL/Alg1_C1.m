function [performance_compare, x_agent, x_bar, transmit] = Alg1_C1(x0, n_agents, gc1, gc2, gc3, gc4, gc5, G_gf, L_aug, T)
    
    fprintf('Starting Alg1_C1 ... \n');
    iter_num = T;
    psi = 0.5;
    ...
    for i = 1:n_agents
        q_0(i) = Unbiased_l_bits_quantizer(x0(i), l);
    end
    ...
    for t = 2:T
        ...
        for i = 1:n_agents
            q_0(i) = Unbiased_l_bits_quantizer(x_iter(i) - a_0_temp(i), l);
        end
