function [performance_compare, x_agent, x_bar, transmit] = Alg2_C3(x0, n_agents, gc1, gc2, gc3, gc4, gc5, G_gf, L_aug, T)
    
    fprintf('Starting Alg2_C3 ... \n');
    iter_num = T;
    psi = 1;
    sigma = 0.01;
    ...
    for t = 2:T
        ...
        e_temp = e(:, t);
        for i = 1:n_agents
            q_0(i) = Norm_sign(sigma*e_temp(i) + x_iter(i) - a_0_temp(i));
        end
        ...
        transmit(t) = transmit(t-1) + 4*d + 2*b;
    end
