function [xminuxbar, sq_grad, transmit] = Alg_1_Unbiased_2_bits_quantizerE(L_aug, x, n,N,gc,lambda,aalpha, features, labels,bs, iter_num, eta, alpha, beta, psi)

    fprintf('Alg_1_Unbiased_2_bits_quantizer\n');
    ...
    for i = 1: N
        q_0( (i-1)*n+1 : i*n) = Unbiased_l_bits_quantizer(x0(:, i), l);
    end
    ...
    for t = 2:iter_num
        ...
        for i = 1:N
            q_0( (i-1)*n+1 : i*n) = Unbiased_l_bits_quantizer(x_comp(:, i) - a_comp(:, i), l);
        end
