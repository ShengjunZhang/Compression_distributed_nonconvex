function [xminuxbar, sq_grad, transmit] = Alg_3_single_bit_binary_quantizer(L_aug, x, n,N,gc,lambda,aalpha, features, labels,bs, iter_num, eta, alpha, beta, s0, gamma)
    ...
    for i = 1: N
        q_0( (i-1)*n+1 : i*n) = Single_bit_binary_quantizer(x0(:, i) / s0);
    end
