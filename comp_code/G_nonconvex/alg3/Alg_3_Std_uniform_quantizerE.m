function [xminuxbar, sq_grad, transmit] = Alg_3_Std_uniform_quantizerE(L_aug, x, n,N,gc,lambda,aalpha, features, labels,bs, iter_num, eta, alpha, beta, s0, gamma, delta)
